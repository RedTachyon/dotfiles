...
# This script creates symlinks in your home directory for every file
...
# Collect all files from the source directory into an array.
mapfile -d '' items < <(find "$SOURCE_DIR" -type f -print0)
